...
> = {
  pipeline: {
    modulo: 'Vendas',
    titulo: 'Preparando suas vendas',
    descricao: 'Carregando clientes e etapas da venda.',
    metricas: 3,
    colunas: 5,
    momentoEscuro: false,
  },
  ...
  calls: {
    modulo: 'Reuniões',
    titulo: 'Preparando suas reuniões',
  ...
  consultor: {
    ...
    descricao: 'Verificando vendas, reuniões, propostas e projetos.',
    metricas: 0,
    colunas: 4,
    momentoEscuro: true,
  },
