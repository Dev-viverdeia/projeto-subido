...
export const projetosPreview: SolucaoResumo[] = [
  ...
  projetoResumo(
    ...
    'Encontre empresas e contatos para a equipe de vendas abordar.',
    '7 a 12 dias úteis',
  ),
  projetoResumo(
    '03',
    ...
    'Organize conversas em resumos, tarefas e próximos passos de venda.',
    '10 a 15 dias úteis',
  ),
  projetoResumo(
    '04',
    ...
    'Prepare conteúdos para diferentes canais, com revisão antes de publicar.',
    '7 a 10 dias úteis',
  ),
  projetoResumo(
    '05',
    ...
    'Colete opiniões, identifique problemas e ajude a equipe a agir.',
    '5 a 10 dias úteis',
  ),
];
