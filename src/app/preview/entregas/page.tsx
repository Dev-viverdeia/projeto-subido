...
const PROJETOS: ResumoProjetoExecucao[] = [
  ...
  },
  {
    ...
    atualizadoEm: '2026-08-20T18:00:00.000Z',
    feitas: 9,
    total: 9,
    proximaTarefa: null,
    proximaAcaoPrazoEm: null,
  ...
  },
  {
    ...
    titulo: 'Assistente interno de procedimentos',
    empresa: 'Clínica Serra',
    status: 'concluido',
    prazoEm: '2026-07-30T12:00:00.000Z',
    atualizadoEm: '2026-08-21T18:00:00.000Z',
    feitas: 7,
    total: 7,
    proximaTarefa: null,
    proximaAcaoPrazoEm: null,
    ...
    evolucao: {
      ...
      status: 'registrada',
      revisaoEm: '2026-08-21',
      resultadoObservado: 'A equipe passou a localizar os procedimentos em menos de dois minutos.',
      evidenciaResultadoUrl: null,
      decisao: 'manter',
      proximoPasso: 'Revisar os acessos novamente em setembro.',
