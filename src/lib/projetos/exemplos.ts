...
import { exemploAulaReunioes, exemploPassoReunioes } from './exemplos-reunioes';
...
export function exemploPassoProjeto(slug: string, passoId: string) {
  return (
    exemploPassoNina(slug, passoId) ??
    exemploPassoProspeccao(slug, passoId) ??
    exemploPassoReunioes(slug, passoId)
  );
}
export function exemploAulaProjeto(slug: string, titulo: string) {
  return (
    exemploAulaNina(slug, titulo) ??
    exemploAulaProspeccao(slug, titulo) ??
    exemploAulaReunioes(slug, titulo)
  );
}
